...
To run ARSnova yourself, see our link:docs/admin/installation.adoc[installation documentation].

If you are upgrading an existing version 3 installation, read link:docs/admin/upgrading-to-v4.adoc[] first.
