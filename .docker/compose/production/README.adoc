...
|CORE_TAG |3.1.20210121 |Docker tag (repository branch) for Core Backend
|WSGW_TAG |3.1.20210106 |Docker tag (repository branch) for WebSocket Gateway
|HTTPGW_TAG |3.1.20210108 |Docker tag (repository branch) for HTTP Gateway
|AUTH_TAG |3.1.20210106 |Docker tag (repository branch) for Auth Service
|COMMENT_TAG |3.1.20210109 |Docker tag (repository branch) for Comment Service
|WEB_TAG |3.1.20210111 |Docker tag (repository branch) for Webclient
