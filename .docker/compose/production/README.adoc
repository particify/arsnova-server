...
|CORE_TAG |3.6.20220321 |Docker tag (repository branch) for Core Backend
|WSGW_TAG |3.6.20220321 |Docker tag (repository branch) for WebSocket Gateway
|HTTPGW_TAG |3.6.20220321 |Docker tag (repository branch) for HTTP Gateway
|AUTH_TAG |3.6.20220321 |Docker tag (repository branch) for Auth Service
|COMMENT_TAG |3.6.20220321 |Docker tag (repository branch) for Comment Service
|WEB_TAG |3.6.20220409 |Docker tag (repository branch) for Webclient
