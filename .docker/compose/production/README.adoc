...
|CORE_TAG |3.2.20210325 |Docker tag (repository branch) for Core Backend
|WSGW_TAG |3.2.20210330 |Docker tag (repository branch) for WebSocket Gateway
|HTTPGW_TAG |3.2.20210319 |Docker tag (repository branch) for HTTP Gateway
|AUTH_TAG |3.2.20210323 |Docker tag (repository branch) for Auth Service
|COMMENT_TAG |3.2.20210319 |Docker tag (repository branch) for Comment Service
|WEB_TAG |3.2.20210411 |Docker tag (repository branch) for Webclient
