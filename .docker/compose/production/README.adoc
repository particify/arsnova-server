...
|CORE_TAG |3.12.20250313 |Docker tag (repository branch) for Core Backend
|WSGW_TAG |3.12.20250313 |Docker tag (repository branch) for WebSocket Gateway
|HTTPGW_TAG |3.12.20250313 |Docker tag (repository branch) for HTTP Gateway
|AUTH_TAG |3.12.20250313 |Docker tag (repository branch) for Auth Service
|COMMENT_TAG |3.12.20250313 |Docker tag (repository branch) for Comment Service
|WEB_TAG |3.12.20250313 |Docker tag (repository branch) for Webclient
|FORMATTING_TAG|3.12.20250313 |Docker tag (repository branch) for Formatting Service
|=======
